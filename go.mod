module github.com/plantoncloud/aws-secrets-manager-pulumi-module
...
require (
	...
	github.com/plantoncloud/pulumi-module-golang-commons v0.0.0-20240907125804-484a92a4b441
